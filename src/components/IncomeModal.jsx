...
function IncomeModal({isIncomModalOpen, handleIncomModalClose, handleIncome, controlEnter}) {
            ...
            <div className="mdl-container">
                ...
                <div className="mdl-body">
                    ...
                    <div className='form-group d-flex gap-2'>
                        <input type="text" onKeyUp={controlEnter} onChange={(e) => setAmount(e.target.value)} className='form-control'  placeholder="Enter Income" />
